...
import { BellRing, ChartNoAxesCombined, LayoutDashboard, Radar, Settings, ShieldAlert, Wallet, Waves, Compass, CandlestickChart, PanelsTopLeft } from "lucide-react";
  ...
  return (
    <aside className="hidden w-64 shrink-0 flex-col border-r border-white/10 bg-[rgba(6,9,20,0.95)] p-5 lg:flex">
      <div className="mb-8 flex items-center gap-3">
        <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gradient-to-br from-[#9945FF] via-[#00C2FF] to-[#14F195] shadow-[0_0_30px_rgba(153,69,255,0.45)]">
          <PanelsTopLeft className="h-5 w-5 text-black" />
        </div>
        <div>
